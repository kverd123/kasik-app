...
export const RECIPE_IMAGES: Record<string, string> = {
  ...
  // Sebzeler
  'bezelye': 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=200&h=200&fit=crop',
  'karnabahar': 'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=200&h=200&fit=crop',
  'ispanak': 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=200&h=200&fit=crop',
  'kereviz': 'https://images.unsplash.com/photo-1580391564590-aeca65c5e2d3?w=200&h=200&fit=crop',
  'enginar': 'https://images.unsplash.com/photo-1580391564590-aeca65c5e2d3?w=200&h=200&fit=crop',
  'pirasa': 'https://images.unsplash.com/photo-1580391564590-aeca65c5e2d3?w=200&h=200&fit=crop',
  'bamya': 'https://images.unsplash.com/photo-1425543103986-22abb7d7e8d2?w=200&h=200&fit=crop',
  'semizotu': 'https://images.unsplash.com/photo-1576045057995-568f588f82fb?w=200&h=200&fit=crop',
  'domates': 'https://images.unsplash.com/photo-1546470427-0d4db154ceb8?w=200&h=200&fit=crop',
  'biber': 'https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=200&h=200&fit=crop',
  'salatalik': 'https://images.unsplash.com/photo-1449300079323-02e209d9d3a6?w=200&h=200&fit=crop',
  'nohut': 'https://images.unsplash.com/photo-1515543904279-0a13c4741f85?w=200&h=200&fit=crop',
  'fasulye': 'https://images.unsplash.com/photo-1551462147-37885acc36f1?w=200&h=200&fit=crop',
  'barbunya': 'https://images.unsplash.com/photo-1551462147-37885acc36f1?w=200&h=200&fit=crop',
  // Meyveler
  'erik': 'https://images.unsplash.com/photo-1502903089999-678d9f0e0ab4?w=200&h=200&fit=crop',
  'seftali': 'https://images.unsplash.com/photo-1595124216650-1dead4736008?w=200&h=200&fit=crop',
  'balkabagi': 'https://images.unsplash.com/photo-1570586437263-ab629fccc818?w=200&h=200&fit=crop',
  'kayisi': 'https://images.unsplash.com/photo-1592681378614-73b3f70c9b54?w=200&h=200&fit=crop',
  'nar': 'https://images.unsplash.com/photo-1615485290382-441e4d049cb5?w=200&h=200&fit=crop',
  'cilek': 'https://images.unsplash.com/photo-1464965911861-746a04b4bca6?w=200&h=200&fit=crop',
  'incir': 'https://images.unsplash.com/photo-1601379760883-1bb7aefc4135?w=200&h=200&fit=crop',
  'uzum': 'https://images.unsplash.com/photo-1537640538966-79f369143f8f?w=200&h=200&fit=crop',
  // Et & Balık ek
  'somon': 'https://images.unsplash.com/photo-1485921325833-c519f76c4927?w=200&h=200&fit=crop',
  'et': 'https://images.unsplash.com/photo-1602473812169-36a0e1e9021d?w=200&h=200&fit=crop',
  // Yemekler
  'mucver': 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&h=200&fit=crop',
  'menemen': 'https://images.unsplash.com/photo-1525351484163-7529414344d8?w=200&h=200&fit=crop',
  'manti': 'https://images.unsplash.com/photo-1496116218417-1a781b1c416c?w=200&h=200&fit=crop',
  'dolma': 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&h=200&fit=crop',
  'sarma': 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=200&h=200&fit=crop',
  'firin': 'https://images.unsplash.com/photo-1466637574441-749b8f19452f?w=200&h=200&fit=crop',
  'muffin': 'https://images.unsplash.com/photo-1607958996333-41aef7caefaa?w=200&h=200&fit=crop',
  'eriste': 'https://images.unsplash.com/photo-1551462147-ff29053bfc14?w=200&h=200&fit=crop',
  'tost': 'https://images.unsplash.com/photo-1528735602780-2552fd46c7af?w=200&h=200&fit=crop',
  'pogaca': 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=200&h=200&fit=crop',
  // İçecekler
  'kefir': 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=200&h=200&fit=crop',
  'ayran': 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=200&h=200&fit=crop',
  'cacik': 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=200&h=200&fit=crop',
  // Kuruyemiş & Kuru meyve
  'ceviz': 'https://images.unsplash.com/photo-1563412885-f51b2c9d8bf5?w=200&h=200&fit=crop',
  'badem': 'https://images.unsplash.com/photo-1563412885-f51b2c9d8bf5?w=200&h=200&fit=crop',
  'findik': 'https://images.unsplash.com/photo-1563412885-f51b2c9d8bf5?w=200&h=200&fit=crop',
  'kuruyemis': 'https://images.unsplash.com/photo-1563412885-f51b2c9d8bf5?w=200&h=200&fit=crop',
  'tahin': 'https://images.unsplash.com/photo-1563412885-f51b2c9d8bf5?w=200&h=200&fit=crop',
  // Diğer
  'zeytin': 'https://images.unsplash.com/photo-1474979266404-7eaacdc48c09?w=200&h=200&fit=crop',
  'lor': 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=200&h=200&fit=crop',
  'labne': 'https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=200&h=200&fit=crop',
  'kek': 'https://images.unsplash.com/photo-1558961363-fa8fdf82db35?w=200&h=200&fit=crop',
}
